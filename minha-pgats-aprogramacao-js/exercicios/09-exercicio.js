...
console.log(
  `Todos brinquedos foram entregues! - ${brinquedosEntregues.join(",")}`,
);
...
brinquedosComNomeECor.forEach((brinquedo) => {
  console.log(
    `Entregando o brinquedo ${brinquedo.nome}, de cor ${brinquedo.cor}`,
  );
});

// ---

const listaDeBrinquedosDoCachorro = ["Bola", "Osso", "Corda", "Sino"];
